...
class ActiniaHelloWorldTest(ActiniaTestCase):
    ...
    def test_get_helloworld(self):
        ...
        assert "message" in resp.json, "There is no 'message' inside the " \
            "response"
        assert resp.json["message"] == "Hello world!", "The response message" \
            " is wrong"
    ...
    def test_post_helloworld(self):
        ...
        assert "message" in resp.json, "There is no 'message' inside the " \
            "response"
        assert resp.json["message"] == "Hello world TEST!", "The response " \
            "message is wrong"
